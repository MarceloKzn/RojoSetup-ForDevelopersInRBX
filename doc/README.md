...
* Gerar uma versão dividida por páginas (por exemplo: `services.md`, `security.md`, `performance.md`).
* Transformar exemplos em módulos prontos para importação em um template Rojo.
